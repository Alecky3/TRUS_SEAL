...
namespace TrustSeal.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<TSUser> _userStore;
        ...
        private TSUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<TSUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(TSUser)}'. " +
                    $"Ensure that '{nameof(TSUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<TSUser> GetEmailStore()
        {
